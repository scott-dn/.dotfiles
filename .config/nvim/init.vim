...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Compile, test, run
autocmd filetype rust nnoremap <F4> :w <bar> exec '!cargo build'<CR>
autocmd filetype rust nnoremap <F5> :w <bar> exec '!cargo run'<CR>
autocmd filetype rust nnoremap <F6> :w <bar> exec '!cargo test -- --show-output'<CR>
